...
create table if not exists treino (
	id_treino varchar(10) not null,
	id_exercicio varchar(10) not null,
    id_aluno varchar(10) not null,
    serie_exercicio int not null,
    repeticoes_exercicio int not null,
    tempo_exercicio int not null,
    
    primary key (id_treino, id_exercicio, id_aluno),
    constraint fk_exercicio_aluno foreign key (id_aluno) references aluno(id_aluno),
    constraint fk_aluno_exercicio foreign key (id_exercicio) references exercicio(id_exercicio)
